...
/**
 * Strings for component 'theme_ulm', language 'en'
 *
 * @package   theme_ulm
...
<div class="clearfix">
<div class="well">
<h2>University of Ulm</h2>
<p><img class=img-polaroid src="ulm/pix/screenshot.png" /></p>
</div>
<div class="well">
<h3>Theme Credits</h3>
<p>Authors: Synergy Learning<br>
Contact: studio@synergy-learning.com<br>
Website: <a href="http://www.synergy-learning.com">www.synergy-learning.com</a>
</p>
</div></div>';

$string['pluginname'] = 'University of Ulm';
$string['configtitle'] = 'University of Ulm';
...
$string['layoutdesc'] = 'This theme can be used to put both block columns on the side. Check this box if you would like to enable this feature.';
...
$string['themecolordesc'] = 'What colour should your theme be. This is the main colour throughout your theme. Includes: navigation bg, links, button hover and faulty text colour.';
$string['themesecondarycolor'] = 'Theme Secondary Colour';
$string['themesecondarycolordesc'] = 'What colour should your theme secondary color be. This is used for buttons, block titles and headings';
$string['darkenedthemecolor'] = 'Darker Theme Color';
$string['darkenedthemecolordesc'] = 'Set what colour the background of the navigation icons and logout icon should be.';
$string['footerbackground'] = 'Footer Background Colour';
$string['footerbackgrounddesc'] = 'Set what colour the background of the footer should be.';
$string['footercolor'] = 'Footer Text Colour';
$string['footercolordesc'] = 'Set what colour the text of the footer should be.';
$string['lefthighlight'] = 'Left Footer Block Highlights';
$string['lefthighlightdesc'] = 'Set Border and Button Background Colours in Left Footer Block';
$string['middlehighlight'] = 'Middle Footer Block Highlights';
$string['middlehighlightdesc'] = 'Set Border and Button Background Colours in Middle Footer Block';
$string['righthighlight'] = 'Right Footer Block Highlights';
$string['righthighlightdesc'] = 'Set Border and Button Background Colours in Right Footer Block';
...
$string['frontcontentimage'] = 'Front Content Image';
$string['frontcontentimagedesc'] = 'This adds an image below the frontpage content in the middle area';
...
/* iOS Icons */
$string['iosiconinfo'] = 'iOS Homescreen Icons';
$string['iosiconinfodesc'] = 'The them does provide a default icon for iOS and android homescreens. You can upload your custom icons if you wish.';

$string['iosicon'] = 'iOS Icon';
$string['iosicondesc'] = 'Icon should be a PNG files sized 152px by 152px to support all ios devices';

$string['androidicon'] = 'Android Icon';
$string['androidicondesc'] = 'Icon should be a PNG files sized 128px by 128px';

$string['hiandroidicon'] = 'Android Icon (Hi Res)';
$string['hiandroidicondesc'] = 'Icon should be a PNG files sized 192px by 192px';
...
$string['sliderselect'] = 'Slider Select';
$string['sliderselectdesc'] = 'Select which type of slider to use for the front page';
$string['noslider'] = 'No Slider';
$string['parallaxslider'] = 'Parallax Slider';
$string['gridslider'] = 'Grid Slider';
$string['imageslider'] = 'Image Slider';

$string['gridsliderheadingsub'] = 'Grid based promotional slider for the frontpage';
$string['gridsliderdesc'] = 'This creates a 1 or 3 paned promotional grid for your frontpage';

$string['pane1settings'] = 'Pane 1 Settings';
$string['pane2settings'] = 'Pane 2 Settings';
$string['pane3settings'] = 'Pane 3 Settings';

$string['useonlypane1'] = 'Use only 1 Pane';
$string['useonlypane1desc'] = 'You can turn this on to have only 1 pane of items on the front page. If you turn this off, all 3 panes will display';


$string['promoitem'] = 'Promo Item';
$string['promoitemdesc'] = 'First and largest item on this pane';
$string['item2'] = 'Item 2';
$string['item2desc'] = 'Item 2 of the pane';
$string['item3'] = 'Item 3';
$string['item3desc'] = 'Item 3 of the pane';
$string['item4'] = 'Item 4';
$string['item4desc'] = 'Item 4 of the pane';
$string['item5'] = 'Item 5';
$string['item5desc'] = 'Item 5 of the pane';
$string['item6'] = 'Item 6';
$string['item6desc'] = 'Item 6 of the pane';
$string['item7'] = 'Item 7';
$string['item7desc'] = 'Item 7 of the pane';
$string['image'] = 'Image';
$string['imagedesc'] = 'Image to be used for this item';
$string['text'] = 'Text';
$string['textdesc'] = 'Text to be used for button on this item';
$string['url'] = 'URL';
$string['urldesc'] = 'URL to be used for this item\'s button';
$string['color'] = 'Button Color';
$string['colordesc'] = 'Color to be used for this item\'s button';
$string['gacode'] = 'GA Event Code';
$string['gacodedesc'] = 'Event code for onclick parameter of link';
$string['newwindow'] = 'Open in a new window?';
$string['newwindowdesc'] = 'Check if you want to open this link in a new window';
$string['itemdescription'] = 'Item description';
$string['itemdescriptiondesc'] = 'Text to be used for alt parameter of image';

$string['autosliding'] = 'Turn on auto sliding';
$string['autoslidingdesc'] = 'Turn on to let slider automatically change panes';
$string['delay'] = 'Delay (in seconds)';
$string['delaydesc'] = 'Delay before switching to next pane for auto sliding';


$string['imagesliderheading'] = 'Image Slider Settings';
$string['imagesliderheadingsub'] = 'Responsive Image Slider for the frontpage';
$string['imagesliderdesc'] = 'This creates an image slider of up to 6 image for you to display on the front page.';

$string['importexportsettings'] = 'Import/Export Settings';
$string['settingsfile'] = 'Settings File';
$string['importsettings'] = 'Import Settings';
$string['exportsettings'] = 'Export Settings';

/**** Custom ****/
$string['facultytext'] = 'Faculty of';
$string['facultyname'] = 'Name of Faculty';
$string['facultynamedesc'] = 'Name of faculty to display in the header';
...
$string['greytitle'] = 'Faculty of / Centre of';
$string['greytitledesc'] = 'Sets grey title in header.';

$string['maintitle'] = 'Name of Faculty';
$string['maintitledesc'] = 'Name of faculty to display in the header';

$string['help'] = '\'Help\' URL';
$string['helpdesc'] = 'URL for Help Icon in menu bar';

$string['footerblockbg'] = 'Footer Block Background';
$string['footerblockbgdesc'] = 'Background Colour of the footer blocks';

$string['thememenusep'] = 'Theme Menu Seperator';
$string['thememenusepdesc'] = 'Colour of the menu seperator';
